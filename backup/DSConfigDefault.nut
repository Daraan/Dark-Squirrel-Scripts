...
enum eDAutoTxtRepl
{
	...
	//kAltFile	= "ForYourMission.csv"		// A second file, which could be more mission specific. Enable this in your custom config.
...
getconsttable().eDAutoTxtRepl.Categories = {}

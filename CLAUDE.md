...
That harness is not the engine: rendering/AI/physics/sound are stubs, and only DromEd checks
against the real NewDark build. Final verification still happens in DromEd:
